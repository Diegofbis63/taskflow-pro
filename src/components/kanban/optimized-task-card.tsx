...
const statusConfig = {
  ...
  IN_PROGRESS: { label: 'In Progress', color: 'border-blue-300' },
  IN_REVIEW: { label: 'In Review', color: 'border-yellow-300' },
  DONE: { label: 'Done', color: 'border-green-300' }
} as const

export const OptimizedTaskCard = memo<OptimizedTaskCardProps>(({ task, onClick }) => {
